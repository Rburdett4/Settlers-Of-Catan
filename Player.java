...
class Player extends Polygon
{
    ...
    ArrayList<SOC.resource> m_resources;
    String m_name;
    int m_boardWidth;
    int m_boardHeight;
    int m_num;
    ...
    public Player(String name, int width, int height)
    {
        ...
        this.collectResources(SOC.resource.WHEAT, 2);
        this.collectResources(SOC.resource.WOOD, 4);
        this.collectResources(SOC.resource.SHEEP, 2);
        this.collectResources(SOC.resource.BRICK, 4);
    }
